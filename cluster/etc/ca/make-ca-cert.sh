...
cert_ip=144.76.60.131
extra_sans=IP:10.0.0.1,IP:10.0.0.2,DNS:kubernetes,DNS:kubernetes.default,DNS:kubernetes.default.svc,DNS:kubernetes.default.svc.k.2pktfkt.net
cert_dir=/srv/kubernetes/etc/new
cert_group=mr
